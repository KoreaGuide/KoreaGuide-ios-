  ...
  var body: some View {
    VStack {
      ZStack {
        ...
        VStack {
          HStack {
            Text(viewModel.word_list[num].word_kor)
          ...
          HStack {
            Text(viewModel.word_list[num].word_eng)
              .foregroundColor(.black)
          ...
          HStack {
            Button {
              WordApiCaller.myWordDelete(word_folder_id: viewModel.word_folder_id, word_id: viewModel.word_list[num].id) {
                result in
